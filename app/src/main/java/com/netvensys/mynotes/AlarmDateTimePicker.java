...
/**
 * Created by Srinivasa.Nettem on 2/26/2016.
 */
public class AlarmDateTimePicker implements OnClickListener {
    private DatePicker datePicker;
    private TimePicker timePicker;
    private ViewSwitcher viewSwitcher;

    private final int SET_DATE = 1000, SET_TIME = 1001, SET = 1002, CANCEL = 1003;
    ...
    public AlarmDateTimePicker(Activity a,
